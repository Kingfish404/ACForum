<template>
    <div class="inner" id="Tabs">
     ...
     <a href="/?tab=city" class="tab">城市</a><a href="/?tab=qna" class="tab_current">问与答</a><a href="/?tab=hot" class="tab">最热</a><a href="/?tab=all" class="tab">全部</a><a href="/?tab=r2" class="tab">R2</a>
    </div>
</template>